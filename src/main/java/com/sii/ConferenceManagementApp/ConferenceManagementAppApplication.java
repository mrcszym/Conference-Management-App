...
public class ConferenceManagementAppApplication {
	...
	CommandLineRunner runner(LectureRepository lectureRepository) {
		...
		String startTime3 = "2021-06-01 10:00";

		String endTime1 = "2021-06-01 11:45";
		String endTime2 = "2021-06-01 13:45";
		String endTime3 = "2021-06-01 14:45";
		...
		return args -> {
			...
			List<Lecture> lectureList = new ArrayList<>(List.of(
					new Lecture("Prelekcja 1", "sciezka 1", formatStartTime1.format(formatter), formatEndTime1.format(formatter)),
					new Lecture("Prelekcja 1", "sciezka 2", formatStartTime1.format(formatter), formatEndTime1.format(formatter)),
					new Lecture("Prelekcja 1", "sciezka 3", formatStartTime1.format(formatter), formatEndTime1.format(formatter)),

					new Lecture("Prelekcja 2", "sciezka 1", formatStartTime2.format(formatter), formatEndTime2.format(formatter)),
					new Lecture("Prelekcja 2", "sciezka 2", formatStartTime2.format(formatter), formatEndTime2.format(formatter)),
					new Lecture("Prelekcja 2", "sciezka 3", formatStartTime2.format(formatter), formatEndTime2.format(formatter)),

					new Lecture("Prelekcja 3", "sciezka 1", formatStartTime3.format(formatter), formatEndTime3.format(formatter)),
					new Lecture("Prelekcja 3", "sciezka 2", formatStartTime3.format(formatter), formatEndTime3.format(formatter)),
					new Lecture("Prelekcja 3", "sciezka 3", formatStartTime3.format(formatter), formatEndTime3.format(formatter))
